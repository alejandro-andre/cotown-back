...
BEGIN
  ...
  IF ((NEW."Status" = 'solicitud' OR NEW."Status" = 'alternativas')AND NEW."Resource_id" IS NOT NULL) THEN
    ...
    -- Registra el cambio
    INSERT INTO "Booking"."Booking_log" ("Booking_id", "Log") VALUES (NEW.id, 'Pendiente de pago');
  ...
  IF ((NEW."Status" = 'solicitudpagada' OR NEW."Status" = 'alternativaspagada') AND NEW."Resource_id" IS NOT NULL) THEN
    ...
    -- Registra el cambio
    INSERT INTO "Booking"."Booking_log" ("Booking_id", "Log") VALUES (NEW.id, 'Reserva confirmada');
