...
LEFT JOIN "Customer"."Customer_doc" cd ON cd."Customer_id" = b."Customer_id"
LEFT JOIN "Customer"."Customer_doc_type" cdt ON cdt.id = cd."Customer_doc_type_id"
WHERE cdt.id IN (6, 7, 11, 12)
GROUP BY 1, 2, 3, 4, 5
ORDER BY b.id
;
