...
- IBI y gastos de comunidad {{Booking_expenses|decimal(1)}} euros mensuales.
{% endif %}
...
- La última renta del contrato de arrendamiento de vivienda habitual que permaneció vigente hasta {{Resource_flat_last_LAU_date_day}}/{{Resource_flat_last_LAU_date_month}}/{{Resource_flat_last_LAU_date_year}}, cuyo importe ascendía a {{Resource_flat_last_LAU_rent|decimal(1)}} euros mensuales.
