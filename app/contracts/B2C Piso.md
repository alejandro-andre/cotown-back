...
-	 la última renta del contrato de arrendamiento de vivienda habitual que permaneció vigente hasta (fecha de finalización del contrato LAU), cuyo importe ascendía a (importe ultima renta LAU)
...
Aplicada la actualización de la renta conforme al Índice de Precios al Consumo correspondiente, así como el incremento del 10 % autorizado por la realización de obras de mejora en la Vivienda en los dos años anteriores, la renta resultante asciende a (importe total renta con el 10%)
El Arrendatario abonará también: 
-	Gastos por suministros de los que esté dotada la Vivienda y hasta el límite de (importe suministros) por persona y mes
-	IBI (importe IBI)
...
La parte arrendataria abonará al gestor del arrendador Cotown Sharing Life, SL, en concepto de renta, la cantidad de [[Booking_rent|decimal]] euros, dentro de los cinco primeros días de cada mes, mediante domiciliación bancaria o tarjeta bancaria. 
Además, la parte arrendataria abonará [[Booking_final_cleaning|decimal]] euros de limpieza de salida mediante domiciliación bancaria o tarjeta bancaria dentro de los cinco primeros días naturales contados a partir de la fecha de emisión de la factura.
...
El arrendatario entrega a la arrendadora en el transcurso de este acto el importe de (importe fianza) en concepto de fianza legal equivalente a la parte proporcional de un mes de renta en función de la duración del contrato, para garantizar el cumplimiento por la Arrendataria de todas las obligaciones y responsabilidades que asume. 
