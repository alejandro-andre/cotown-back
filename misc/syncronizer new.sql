...
DECLARE
    ...
    old_parallel_workers TEXT;
    notices int;
BEGIN
    -- Avoid parallel workers
    old_parallel_workers := current_setting('max_parallel_workers_per_gather');
    ...
    RAISE NOTICE '!!!!Cambiar nombres de roles';
    ...
    RAISE NOTICE '!!!!Cambiar nombres de usuarios';
    ...
    RAISE NOTICE '!!!!Cambiar usuario de administrador a no-administrador o vicerversa';
    ...
    RAISE NOTICE '!!!!Cambiar nombres de tablas';
    ...
    RAISE NOTICE '!!!!Cambiar nombres de tipos enumerados';
    ...
    RAISE NOTICE '!!!!Cambiar tablas de esquema';
    ...
    RAISE NOTICE '!!!!Cambiar tipos enumerados de esquema';
    ...
    RAISE NOTICE '!!!!Cambiar nombres de atributos';
    ...
    RAISE NOTICE '!!!!Cambiar tipos de atributos';
    FOR enumValue IN 
    ...
    RAISE NOTICE '!!!!Borrar referencias que ya no estén en el modelo ';
    ...
    RAISE NOTICE '!!!!Borrar índices que ya no estén en el modelo';
    FOR index IN SELECT n.nspname AS schemaname, 
                        t.relname AS tablename, 
    ...
    RAISE NOTICE '!!!!Borrar tablas que ya no estén en el modelo';
    ...
    RAISE NOTICE '!!!!Borrar campos que ya no estén en el modelo';
    ...
    RAISE NOTICE '!!!!Borrar tipos enumerados que ya no estén en el modelo';
    ...
    RAISE NOTICE '!!!!Crear tipos enumerados nuevos';
    ...
    -- Crear tablas nuevas
    RAISE NOTICE '!!!!Crear tablas nuevas';
    ...
    RAISE NOTICE '!!!!Crear constraints nuevas (references)';
    ...
    RAISE NOTICE '!!!!Borrar roles (roles y usuarios) que ya no estén en el modelo';
    ...
    -- Crear roles nuevos
    RAISE NOTICE '!!!!Crear roles nuevos';
    ...
    RAISE NOTICE '!!!!Crear usuarios nuevos';
    ...
    RAISE NOTICE '!!!!Revocar permisos de tablas';
    ...
    RAISE NOTICE '!!!!Conceder permisos de tablas';
    notices := 0;
    FOR "record" IN SELECT DISTINCT e."schema", r."name" AS "role" 
        ...
        -- Conceder permiso
        RAISE NOTICE '   !!!!% %', "record"."schema", "record"."role";
    ...
    FOR "record" IN SELECT e."schema", e."name", array_remove(p."types", 'MENU') AS "types", r."name" AS "role" 
        ...
        -- Conceder permiso
        notices := notices + 1;
        RAISE NOTICE '   !!!!% % % % %', "notices", "record"."types", "record"."schema", "record"."name", "record"."role";
        sql := 'GRANT ' || array_to_string("record"."types", ',') || ' ON "' || "record"."schema" || '"."' || "record"."name" || '" TO "' || "record"."role" || '"';
        EXECUTE sql;
    END LOOP;

    -- Revocar permisos de columnas
    RAISE NOTICE '!!!!Revocar permisos de columnas';
    ...
    RAISE NOTICE '!!!!Conceder permisos de columnas';
    notices := 0;
    FOR "record" IN SELECT DISTINCT e."schema", r."name" AS "role" 
    ...
    FOR "record" IN SELECT e."schema", e."name", a."name" AS "attributeName", unnest(p."types") AS "types", r."name" AS "role" 
        ...
        -- Conceder permiso
        notices := notices + 1;
        RAISE NOTICE '   !!!!% % % % % %', "notices", "record"."types", "record"."attributeName", "record"."schema", "record"."name", "record"."role";
    ...
    RAISE NOTICE '!!!!Elimitar reglas de row level security ';
    ...
    RAISE NOTICE '!!!!Añadir reglas de row level security';
    ...
    RAISE NOTICE '!!!!Borrar funciones que ya no están';
    ...
    RAISE NOTICE '!!!!Borrar schedules que ya no se necesitan';
    ...
    RAISE NOTICE '!!!!Crear o actualizar funciones';
    FOR function IN SELECT id, schema, name, language, contents, "cronExpression", jobid, "isCustomFunction", "customParameters", "customReturnType"
        ...
        BEGIN
            ...
            EXECUTE 'GRANT USAGE ON SCHEMA "' || function.schema || '" TO public';
    ...
    RAISE NOTICE '!!!!Re-crear triggers nuevos ';
    ...
    RAISE NOTICE '!!!!Borrar triggers de borrado ';
    ...
    RAISE NOTICE '!!!!Borrar triggers de generación de informes';
    FOR entity IN SELECT "id", "schema", "name" 
            FROM "Models"."Entity" LOOP
    ...
    RAISE NOTICE '!!!!Fin';
    PERFORM set_config('max_parallel_workers_per_gather', old_parallel_workers, false);
